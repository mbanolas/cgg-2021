...
//  if($('body > div > div.container > div > div.row > div.table-section > div.table-label > div.floatL.l5').html().trim()=="Usuaris/Usuàrias")
//       $('#gcrud-search-form > div.header-tools > div.floatR > a.btn.btn-default.t5.gc-export').removeClass('hide');
