<div class="container"><br />
    <br />
    <h3>Informe Ingressos / Devolucions</h3>
    <br />

    <?php echo form_open('cobros/excelInformeAyuntamiento', array('class' => "form-horizontal", 'role' => "form")); ?>
    <div class="form-group">
        <label class="control-label col-sm-2" for="taller">Des del:</label>
        <div class="col-sm-2"> 
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="taller">Fins al:</label>
        <div class="col-sm-2"> 
        ...
        <div class="col-sm-2 ">
            <button type="submit" class="btn btn-success hide" id="pdfInformeCobros" name="excelInformeAyuntamiento">
                <span class="glyphicon glyphicon-save-file" aria-hidden="true"></span> 
                Baixar Excel informe Ajuntament</button>
        </div>
...
//verResumen()
        ...
        function verResumen() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_url() ?>" + "index.php/cobros/getInformeAjuntament",
