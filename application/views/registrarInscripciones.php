<div class="container">
<h3>Sol·licitud Inscripcions a tallers</h3><hr>
...
<?php echo form_open('talleres/recibosInscripciones',array('id'=>'form')); ?>
...
<div class="col-sm-4" style="margin-bottom:15px">
    ...
    <label for="cobroTarjetaProfesionales"style="font-weight: normal;">  Cobrament amb targeta Tallers Professionals</label>
</div>
