...
class Talleres_model extends CI_Model {
    ...
    function getListaEsperaTaller($taller,$periodo=0) {
        $numPeriodo=$this->getNumPeriodo($periodo);
        ...
        $sql = "SELECT s.id as numSocio, s.telefono_1 as telefono_1, s.telefono_2 as telefono_2,
              ...
              WHERE r.id_taller='$taller' $whereTrimestres ORDER BY r.orden";
        $result = $this->db->query($sql)->result_array();
        return $result;
    }
    ...
    function getTablaResumenCurso($curso,$tipoTaller="",$periodo="") {
       ...
       if($tipoTaller=='tots'){
        ...
        $pieTabla.='<th class="text-right">'.$totalImportesVoluntarios.'</th>';
        $pieTabla.='<th class="text-right">'.$numAsistentesProfesionales.'</th>';
        $pieTabla.='<th class="text-right">'.$totalImportesProfesionales.'</th>';
        ...
        $pieTabla.='<th class="text-right" style="border-top:4px solid black;border-bottom:4px solid black;border-right:4px solid black;">'.($totalImportesVoluntarios+$totalImportesProfesionales).'</th>';
        $pieTabla.='</tr>';
    ...
    function getTablaTalleresInscritos($curso, $socio) {
        ...
        foreach ($resultAsistentes as $k => $v) {
            // if($this->session->categoria==3  && $v['tipo_taller']=="Professional") continue;
            $asistencias[$v['taller']] = $v['trimestres'];
            //log_message('INFO','asistencias'.' '.$v['taller'].' '.$asistencias[$v['taller']]);
        }
